...
class CategorySeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('categories')->insert([
            ...
            ['name' => 'Bò Xào', 'parent_id' =>'2', 'slug' => 'bo-xao'],
            ['name' => 'Bò Hầm', 'parent_id' =>'2', 'slug' => 'bo-xao'],
            ['name' => 'Cá', 'parent_id' =>'0','slug' => 'ca'],
            ['name' => 'Cá Nướng', 'parent_id' =>'4','slug' => 'ca-nuong'],
            ['name' => 'Cá Om', 'parent_id' =>'4','slug' => 'ca-om'],
            ['name' => 'Heo', 'parent_id' =>'0','slug' => 'heo'],
            ['name' => 'Heo Quay', 'parent_id' =>'6','slug' => 'heo-quay'],
        ]);
    }
}
